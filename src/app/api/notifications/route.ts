...
const notificationsDB: NotificationsDB = {
  recent: [
    ...
    },
    {
      ...
      user: "Andi",
      content:
        'commented on your project "E-commerce Dashboard": "Great design, clean and modern!"',
      time: new Date().toISOString(),
      isRead: true,
    },
  ],
...
export async function GET(): Promise<
  NextResponse<NotificationsDB | ApiResponse>
> {
  try {
    await new Promise((resolve) => setTimeout(resolve, 300)); // Simulate network delay
    const allNotifications = [
      ...notificationsDB.recent,
      ...notificationsDB.previous,
    ];
