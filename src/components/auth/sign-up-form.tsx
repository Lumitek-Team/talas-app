...
export function SignUpForm() {
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (imgBox) imgBox.style.height = "200px";
          ...
          <SignUp
            appearance={{
              elements: {
                ...
                socialButtonsGoogleButton:
                  "bg-green-500 hover:bg-green-600 text-white border-none",
                logoBox:
                  "bg-[url('/logo/logo-talas.svg')] bg-center bg-contain bg-no-repeat h-16",
              },
              variables: {
                colorPrimary: "#68DE68",
