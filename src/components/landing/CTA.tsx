...
const TeamMember = memo(({ member }: { member: { id: number; image: string } }) => (
  ...
  >
    <Image
      ...
      width={176}
      height={208}
      className="w-full h-full object-cover min-[691px]:filter min-[691px]:blur-sm min-[691px]:grayscale min-[691px]:hover:filter-none min-[691px]:hover:scale-110 transition-all duration-300 ease-out"
      loading="lazy"
      priority={false}
      quality={75}
    />
